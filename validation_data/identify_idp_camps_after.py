# This script takes the input CSV file with IDP Camp data between 27 August, 2017 and 30 November, 2017
...
# Load the CSV file
filepath = os.getcwd()
input_filename = "/IDPCamp_Myanmar_detailed_after_270817.csv"
...
output_filename = "/IDPCamp_admin3_after_event.csv"
